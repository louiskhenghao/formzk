...
`@formzk/tamagui` is a new adapter targeting Tamagui v1 — same API shape as `@formzk/mui`, cross-platform (web & React Native). Nothing to migrate; see the [Tamagui adapter guide](./tamagui/overview).
