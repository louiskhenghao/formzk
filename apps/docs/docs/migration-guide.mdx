...
`@formzk/tamagui` is a new adapter supporting Tamagui v1 and v2 — same API shape as `@formzk/mui`, cross-platform (web & React Native). Nothing to migrate; see the [Tamagui adapter guide](./tamagui/overview).
