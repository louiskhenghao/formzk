...
Compatible with **Tamagui v1** and **React 18 / 19**. Your app must be wrapped in a configured `TamaguiProvider` — see the [Tamagui installation guide](https://tamagui.dev/docs/intro/installation).
